/*  -- $HeadURL: https://svn.uv-software.net/projects/uv-software/CAN/I386/DRV/trunk/Drivers/TouCAN/trunk/tst/main.c $ --
 *
 *  project   :  CAN - Controller Area Network
 *
 *  purpose   :  CAN API V3 Tester (Rusoku TouCAN)
 *
 *  copyright :  (C) 2020, UV Software, Berlin
 *
...
//static const char* __revision__  = "$Rev: 897 $";
...
//                goto end;
            fprintf(stderr, "+++ error(%i): CAN FD operation mode not supported!\n", CANERR_NOTSUPP);
            goto end;
        }
    }
    /* reception loop */
