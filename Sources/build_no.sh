...
echo " *" >> build_no.h
echo " *  TouCAN - macOS User-Space Driver for Rusoku TouCAN USB Interfaces" >> build_no.h
echo " *" >> build_no.h
echo " *  Copyright (C) 2020  Uwe Vogt, UV Software, Berlin (info@mac-can.com)" >> build_no.h
echo " *" >> build_no.h
echo " *  This file is part of MacCAN-TouCAN." >> build_no.h
echo " *" >> build_no.h
echo " *  MacCAN-TouCAN is free software : you can redistribute it and/or modify" >> build_no.h
...
echo " *" >> build_no.h
echo " *  MacCAN-TouCAN is distributed in the hope that it will be useful," >> build_no.h
...
echo " *  along with MacCAN-TouCAN.  If not, see <http://www.gnu.org/licenses/>." >> build_no.h
echo " */" >> build_no.h
