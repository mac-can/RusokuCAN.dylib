...
//
//  Copyright (C) 2007,2012-2020  Uwe Vogt, UV Software, Berlin (info@mac-can.com)
//
...
#endif
static const char COPYRIGHT[]   = "Copyright (C) 2007,2012-2020 by Uwe Vogt, UV Software, Berlin";
...
class CCanDriver : public CTouCAN {
public:
...
int main(int argc, const char * argv[]) {
    ...
    /* CAN Tester for Rusoku TouCAN interfaces */
    fprintf(stdout, "%s\n%s\n\n%s\n\n", APPLICATION, COPYRIGHT, WARRANTY);
